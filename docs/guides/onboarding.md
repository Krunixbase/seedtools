...
SeedTools Suite is a deterministic, offline‑first, security‑focused toolkit for Bitcoin recovery, forensics, entropy analysis, and wallet diagnostics.  
This guide helps new developers, auditors, and contributors understand the architecture, workflows, and development process.
