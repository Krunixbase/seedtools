...
Model opiera się na czterech filarach:
...
SeedTools uses a hybrid methodology:
...
These threats originate outside the user’s device.
...
User generates seed with insufficient randomness.

Mitigation: entropy scoring, anomaly detection.

## **Scenario E — Supply‑Chain Attack**
Malicious dependency injected into build.
